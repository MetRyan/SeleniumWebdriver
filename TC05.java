...
public class TC05 {
    ...
    public void testTC05() {
        ...
        String email_address = "Quang08044gffff@gmail.com";
        String password = "Quang0804";
        String confirmPassword = "Quang0804";
        ...
        try {
            ...
            emailInput.clear();
            emailInput.sendKeys("Quangggg111@gmail.com");
            ...
            String png = ("C:\\selenium-webdriver-java-master\\src\\test\\java\\BAITAP\\" + scc + ".png");
